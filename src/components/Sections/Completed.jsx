...
import down from "../../images/Resources.svg";
import pen from "../../images/edit.svg";
import dust from "../../images/Delete.svg";
import NTD from "../../images/NTD.jpg";
...
const Completed = () => {
    ...
    return (
        <>
            {CompletedData.map((training, index) => (
                <div key={index} className="Training_Programm" style={{ marginTop: '2rem' }}>
                    ...
                    <div className="Program_Info">
                        ...
                        <div className="Step3PS">
                            ...
                            <p>{`Completed: ${training.appliedDate}`}</p>
                        </div>
